...
ENCODER_PINS = {
    'osc_type':      (12, 16, None, 'osc_type', 'options', ['saw', 'square', 'sine', 'triangle']),
    'chorus_amount': (18, 22, None, 'chorus_depth', 'continuous', (0.0, 0.02, 0.0005)),
    'volume':        (3, 5, 7, 'volume', 'continuous_toggle_func', (0.0, 1.0, 0.01), 'toggle_volume_mute'),
    'arp_rate_enc':  (11, 13, 15, 'arp_rate', 'options_toggle_param', [4, 8, 16, 32], 'arp_on'),
    'cutoff':        (24, 26, None, 'filter_cutoff', 'log_continuous', (20.0, 18000.0, 1.05)),
    'resonance':     (36, 32, None, 'filter_resonance', 'continuous', (0.0, 0.95, 0.01)),
    'env_amount':    (38, 40, None, 'filter_env_amount', 'continuous', (-8000.0, 8000.0, 100.0)),
    'attack':        (19 , 21, None, 'attack', 'log_continuous', (0.001, 5.0, 1.02)),
    'decay':         (23, 29, None,  'decay', 'log_continuous', (0.01, 5.0, 1.02)),
    'sustain':       (31, 33, None, 'sustain', 'continuous', (0.0, 1.0, 0.01)),
    'release':       (35, 37, None, 'release', 'log_continuous', (0.01, 8.0, 1.02)),
}
